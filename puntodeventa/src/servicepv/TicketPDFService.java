...
public class TicketPDFService {
 ...
 //   		String urlpdf, String urlQR, List<DetalleVenta> detalles ) throws Exception {
        ...
        document.add(new Paragraph("Domicilio: "+domicilio+ " "+numero + " Col."+ colonia, normalb));
        document.add(new Paragraph("Ciudad:"+ciudad+ "," +estado + "C.P."+ codpostal, normalb));
        ...
        document.add(new Paragraph("FOLIO FISCAL: " + folioventa, normal));
